    ...
    <main className="w-full bg-white selection:bg-[#0A192F] selection:text-white flex flex-col min-h-screen overflow-hidden">
      ...
      */}
      ...
      {/* 
        ...
        Establishing the framework before detailing the specific programs.
        =======================================================================
      */}
      ...
      {/* 
        ...
        Deep analytical breakdown of the food security logistics.
        =======================================================================
      */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <div className="lg:col-span-4 relative">
              <div className="sticky top-40">
                <div className="font-playfair text-[#1B4F9B] text-[8rem] font-bold opacity-5 mb-6 leading-none tracking-tighter">
                  01
                </div>
            ...
            <div className="lg:col-span-8">
              <div className="prose prose-lg prose-slate max-w-none font-jakarta text-[#0A192F] leading-[2] font-medium mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-slate-200">
                ...
                <div className="p-10 md:p-14 border-b md:border-b-0 md:border-r border-slate-200 bg-white hover:bg-[#F8FAFC] transition-colors duration-500 group">
                  <h5 className="font-jakarta text-[10px] uppercase tracking-[0.3em] font-extrabold text-[#1B4F9B] mb-5">
                    {dict.vetting_label}
                  </h5>
                  <h6 className="font-playfair text-2xl md:text-3xl font-bold text-[#0A192F] mb-5 tracking-tight">
                    {dict.vetting_title}
                  </h6>
              ...
              {/* Ramadan Callout - Institutional Alert Style */}
              <div className="mt-16 p-12 md:p-16 border-l-8 border-[#1B4F9B] bg-[#F8FAFC] shadow-sm relative overflow-hidden">
                ...
                <h5 className="font-jakarta text-[10px] uppercase tracking-[0.4em] font-extrabold text-[#1B4F9B] mb-4">
                  {dict.ramadan_label}
                </h5>
                <h6 className="font-playfair text-3xl md:text-4xl font-bold text-[#0A192F] mb-6 tracking-tight">
                  {dict.ramadan_title}
                </h6>
                <p className="font-jakarta text-base text-[#475569] leading-[1.8] mb-10 font-medium">
                  {dict.ramadan_desc}
                </p>
                {/* i18n ROUTING */}
                <Link 
                  href={`/${locale}/donate`}
                  className="group inline-flex items-center gap-4 font-jakarta text-[11px] uppercase tracking-[0.3em] font-extrabold text-[#1B4F9B] hover:text-[#0A192F] transition-colors"
                >
                  {dict.ramadan_btn} 
      ...
      {/* 
        ...
        High contrast. Dark blue background to signify religious/institutional gravity.
        =======================================================================
      */}
      <section className="py-32 md:py-48 bg-[#0A192F] relative border-y-8 border-[#1B4F9B] overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.03]" aria-hidden="true">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs><pattern id="zakat-grid" width="60" height="60" patternUnits="userSpaceOnUse"><path d="M 60 0 L 0 0 0 60" fill="none" stroke="#FFFFFF" strokeWidth="1"/></pattern></defs>
            <rect width="100%" height="100%" fill="url(#zakat-grid)" />
          </svg>
        </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <div className="lg:col-span-8 order-2 lg:order-1">
              ...
              <div className="prose prose-lg md:prose-xl prose-slate max-w-none font-jakarta text-white leading-[2] font-medium mb-20">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row gap-8 bg-white/5 p-12 md:p-14 border border-white/10 hover:border-[#4793FF]/50 transition-colors duration-500">
                  <div className="w-16 h-16 flex-shrink-0 bg-[#1B4F9B] flex items-center justify-center text-white shadow-lg">
                    <span className="font-playfair font-bold text-2xl">100%</span>
                  </div>
                  <div>
                    <h5 className="font-jakarta text-[10px] uppercase tracking-[0.3em] font-extrabold text-[#4793FF] mb-3">{dict.zakat_1_label}</h5>
                    <h6 className="font-playfair text-2xl md:text-3xl font-bold text-white mb-4 tracking-tight">{dict.zakat_1_title}</h6>
                    <p className="font-jakarta text-sm text-slate-300 leading-[1.8] font-medium">
                      {dict.zakat_1_desc}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-8 bg-white/5 p-12 md:p-14 border border-white/10 hover:border-[#4793FF]/50 transition-colors duration-500">
                  ...
                  <div>
                    <h5 className="font-jakarta text-[10px] uppercase tracking-[0.3em] font-extrabold text-[#4793FF] mb-3">{dict.zakat_2_label}</h5>
            ...
            <div className="lg:col-span-4 order-1 lg:order-2 relative">
              <div className="sticky top-40 lg:pl-16">
                <div className="font-playfair text-[#4793FF] text-[8rem] font-bold opacity-10 mb-6 leading-none tracking-tighter">
                  02
                </div>
                <h3 className="font-jakarta text-[11px] uppercase tracking-[0.4em] font-extrabold text-[#4793FF] mb-6 border-l-2 border-[#4793FF] pl-4">
                  {dict.p2_label}
                </h3>
                ...
                <p className="font-jakarta text-sm text-slate-300 leading-[1.8] font-medium mb-12">
                ...
                <Link 
                  href={`/${locale}/donate`}
                  className="group inline-flex items-center justify-center gap-4 font-jakarta text-[11px] uppercase tracking-[0.3em] font-extrabold bg-white text-[#0A192F] px-10 py-6 hover:bg-[#4793FF] hover:text-white transition-colors duration-500 w-full shadow-2xl"
                >
                  {dict.zakat_btn}
      ...
      {/* 
        ...
        Massive architectural blocks for the remaining pillars.
        =======================================================================
      */}
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="relative group border border-slate-200 bg-[#F8FAFC] p-12 md:p-16 hover:shadow-2xl transition-all duration-700 hover:bg-white">
              ...
              <div className="pt-8">
                <div className="font-playfair text-[#1B4F9B] text-[7rem] font-bold opacity-5 mb-8 leading-none tracking-tighter">
                  03
                </div>
                <h3 className="font-jakarta text-[10px] uppercase tracking-[0.4em] font-extrabold text-[#1B4F9B] mb-5">
                  {dict.p3_label}
                </h3>
                ...
                <p className="font-jakarta text-sm text-[#475569] leading-[1.9] font-medium mb-12">
                  {dict.p3_desc}
                </p>
                {/* i18n ROUTING */}
                <Link 
                  href={`/${locale}/academy`}
                  className="inline-flex items-center gap-4 font-jakarta text-[11px] uppercase tracking-[0.3em] font-extrabold text-[#0A192F] hover:text-[#1B4F9B] transition-colors pb-3 border-b-2 border-[#0A192F] hover:border-[#1B4F9B]"
                >
                  {dict.p3_btn}
