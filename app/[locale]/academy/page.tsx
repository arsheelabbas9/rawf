...
export default async function Academy({ 
  ...
  return (
    <main className="w-full bg-white selection:bg-[#0A192F] selection:text-white flex flex-col min-h-screen overflow-hidden">
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24 relative z-10 w-full pt-32 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-end mt-16 md:mt-24 border-t border-slate-200 pt-12">
            <div className="lg:col-span-7">
              <p className="text-[#1B4F9B] text-xl md:text-3xl leading-[1.4] font-semibold max-w-3xl tracking-tight">
            ...
            <div className="lg:col-span-5 flex flex-col gap-8 pb-4">
              ...
              <div className="flex gap-10">
                <div className="flex flex-col border-l-2 border-[#1B4F9B] pl-5">
                  ...
                  <span className="text-[9px] uppercase tracking-[0.25em] font-extrabold text-[#475569] mt-2">{dict.stat1_label}</span>
                </div>
                <div className="flex flex-col border-l-2 border-[#1B4F9B] pl-5">
                  <span className="font-playfair text-4xl font-bold text-[#0A192F] tracking-tighter">{dict.stat2_val}</span>
                  <span className="text-[9px] uppercase tracking-[0.25em] font-extrabold text-[#475569] mt-2">{dict.stat2_label}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-slate-200">
            <article className="bg-white p-12 md:p-16 border-b md:border-b-0 md:border-r border-slate-200 hover:bg-[#F8FAFC] transition-colors duration-500 group">
              ...
              <h3 className="text-[11px] uppercase tracking-[0.3em] font-extrabold text-[#0A192F] mb-5">{dict.pillar1_title}</h3>
              <p className="text-sm text-[#475569] leading-[1.8] font-medium">{dict.pillar1_desc}</p>
            </article>
            <article className="bg-white p-12 md:p-16 border-b md:border-b-0 md:border-r border-slate-200 hover:bg-[#F8FAFC] transition-colors duration-500 group">
              ...
              <h3 className="text-[11px] uppercase tracking-[0.3em] font-extrabold text-[#0A192F] mb-5">{dict.pillar2_title}</h3>
              <p className="text-sm text-[#475569] leading-[1.8] font-medium">{dict.pillar2_desc}</p>
            </article>
            <article className="bg-white p-12 md:p-16 hover:bg-[#F8FAFC] transition-colors duration-500 group">
              ...
              <h3 className="text-[11px] uppercase tracking-[0.3em] font-extrabold text-[#0A192F] mb-5">{dict.pillar3_title}</h3>
              <p className="text-sm text-[#475569] leading-[1.8] font-medium">{dict.pillar3_desc}</p>
            </article>
          </div>
        </div>
      </section>

      {/* NARRATIVE ARCHIVE 1: THE CREATIVE MIND */}
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24">
          <header className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-10">
            <div className="max-w-3xl">
              <span className="text-[10px] uppercase tracking-[0.4em] font-extrabold text-[#1B4F9B] block mb-6">{dict.arc1_label}</span>
            ...
            <p className="text-sm text-[#475569] leading-[1.8] font-medium max-w-lg">{dict.arc1_desc}</p>
          </header>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col bg-[#F8FAFC] border border-slate-200 p-3 group">
              <div className="relative w-full aspect-[4/3] bg-slate-100 overflow-hidden">
                <img src="/images/academy/anpa8.jpg" alt="Joyful Classroom Experience" className="w-full h-full object-cover grayscale-[10%] group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105" loading="lazy" />
              </div>
              <div className="mt-4 text-[10px] uppercase tracking-[0.2em] font-extrabold text-[#0A192F]">{dict.arc1_img1}</div>
            </div>
            <div className="flex flex-col bg-[#F8FAFC] border border-slate-200 p-3 group">
              <div className="relative w-full aspect-[4/3] bg-slate-100 overflow-hidden">
                <img src="/images/academy/anpa10.jpg" alt="Student holding craft project" className="w-full h-full object-cover grayscale-[10%] group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105" loading="lazy" />
              </div>
              <div className="mt-4 text-[10px] uppercase tracking-[0.2em] font-extrabold text-[#0A192F]">{dict.arc1_img2}</div>
            </div>
            <div className="flex flex-col bg-[#F8FAFC] border border-slate-200 p-3 group">
              <div className="relative w-full aspect-[4/3] bg-slate-100 overflow-hidden">
                <img src="/images/academy/anpa9.jpg" alt="Student displaying sheep craft" className="w-full h-full object-cover grayscale-[10%] group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105" loading="lazy" />
              </div>
              <div className="mt-4 text-[10px] uppercase tracking-[0.2em] font-extrabold text-[#0A192F]">{dict.arc1_img3}</div>
            </div>
          </div>
        </div>
      </section>

      {/* NARRATIVE ARCHIVE 2: SPIRITUAL DEVOTION */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="order-2 lg:order-1 relative flex flex-col gap-6">
              <div className="w-full h-[350px] border border-slate-200 shadow-sm relative group overflow-hidden bg-white p-2">
                ...
                <div className="absolute top-6 left-6 bg-white px-4 py-2 text-[9px] uppercase tracking-[0.3em] font-extrabold text-[#1B4F9B] border border-slate-200 shadow-sm">{dict.arc2_badge}</div>
              </div>
            ...
            <article className="order-1 lg:order-2 relative z-10">
              <header className="mb-8">
                <span className="text-[10px] uppercase tracking-[0.4em] font-extrabold text-[#1B4F9B] block mb-4">{dict.arc2_label}</span>
                <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#0A192F] leading-[1.1] tracking-tight">{dict.arc2_title_1} <br/> {dict.arc2_title_2}</h2>
              </header>
              <div className="text-sm text-[#475569] leading-[1.8] font-medium space-y-6">
                <p>{dict.arc2_desc_1}</p>
                <p>{dict.arc2_desc_2}</p>
              </div>
            </article>
          </div>
        </div>
      ...
      {/* NARRATIVE ARCHIVE 3: TANGIBLE WELFARE */}
      <section className="py-24 md:py-32 bg-white relative overflow-hidden border-b border-slate-200">
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24">
          <header className="mb-16 text-center max-w-3xl mx-auto">
            <span className="text-[10px] uppercase tracking-[0.4em] font-extrabold text-[#1B4F9B] block mb-6">{dict.arc3_label}</span>
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#0A192F] leading-[1.1] tracking-tight mb-6">{dict.arc3_title_1} <br/> {dict.arc3_title_2}</h2>
            <p className="text-sm text-[#475569] leading-[1.8] font-medium">{dict.arc3_desc}</p>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      {/* NARRATIVE ARCHIVE 4: COMMUNITY & CONFIDENCE */}
      <section className="py-24 md:py-32 bg-[#F8FAFC] relative overflow-hidden border-b border-slate-200">
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <article className="relative z-10">
              <header className="mb-8">
                <span className="text-[10px] uppercase tracking-[0.4em] font-extrabold text-[#1B4F9B] block mb-4">{dict.arc4_label}</span>
                <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#0A192F] leading-[1.1] tracking-tight">{dict.arc4_title_1} <br/> {dict.arc4_title_2}</h2>
              </header>
              <div className="text-sm text-[#475569] leading-[1.8] font-medium space-y-6">
                <p>{dict.arc4_desc_1}</p>
                <p>{dict.arc4_desc_2}</p>
              </div>
            </article>
            <div className="relative h-[600px] w-full">
              <div className="absolute right-0 bottom-0 w-[85%] h-[400px] border border-slate-200 shadow-lg z-10 bg-white p-2 group overflow-hidden">
                <img src="/images/academy/anpa2.jpg" alt="Student Assembly" className="w-full h-full object-cover grayscale-[10%] group-hover:grayscale-0 transition-all duration-700" loading="lazy" />
              </div>
              <div className="absolute left-0 top-0 w-[70%] h-[350px] border border-slate-200 shadow-2xl z-20 bg-white p-2 group overflow-hidden">
                <img src="/images/academy/anpa3.jpg" alt="Girls performing on stage" className="w-full h-full object-cover grayscale-[10%] group-hover:grayscale-0 transition-all duration-700" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 md:py-40 bg-white relative">
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24 relative z-10 text-center flex flex-col items-center">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[10px] uppercase tracking-[0.3em] font-extrabold text-[#1B4F9B]">{dict.footer_label}</span>
            <div className="h-px w-8 bg-[#1B4F9B]"></div>
          </div>
          <h2 className="font-playfair text-5xl md:text-7xl font-bold text-[#0A192F] tracking-tight mb-8">{dict.footer_title}</h2>
          <p className="text-[#475569] text-base md:text-lg font-medium max-w-2xl mb-12 leading-relaxed">{dict.footer_desc}</p>
          <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto">
            <Link href={`/${locale}/donate`} className="group inline-flex items-center justify-center gap-3 text-xs uppercase tracking-[0.2em] font-extrabold bg-[#0A192F] text-white px-12 py-5 hover:bg-[#1B4F9B] transition-colors duration-500 shadow-sm">
              {dict.footer_btn1}
              <svg className="w-4 h-4 transition-transform duration-500 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
            </Link>
            <Link href={`/${locale}/contact`} className="text-xs uppercase tracking-[0.2em] font-extrabold bg-transparent text-[#0A192F] border border-[#0A192F] px-12 py-5 hover:bg-[#F8FAFC] transition-colors duration-500">
              {dict.footer_btn2}
            </Link>
          </div>
        </div>
