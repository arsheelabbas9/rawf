...
// Protects the client-side render from crashing if JSON keys are missing.
// ============================================================================
const fallbackDict = {
  ...
  footer_title_1: "Ready to",
  footer_title_2: "make an impact?",
  footer_desc: "Every intervention and program executed by the foundation is powered exclusively by individual donor trust. Access our secure terminal to verify our institutional banking credentials and initiate your transfer.",
  footer_btn1: "Access Secure Terminal",
  footer_btn2: "Review All Programs"
};
...
export default function Contact({ 
  ...
  // Client-side dictionary loader for interactive component
  useEffect(() => {
    const fetchDictionary = async () => {
      try {
        ...
        // Merge the fetched dictionary with fallbacks to guarantee absolute stability
  ...
  // High-end simulated submission handler using explicit 'event' naming
  const handleTransmit = (event: React.FormEvent) => {
    event.preventDefault();
    setIsSubmitting(true);

    // Simulate a secure network transmission (1.5 seconds)
    setTimeout(() => {
  ...
  return (
    <main className="w-full bg-white selection:bg-[#0A192F] selection:text-white flex flex-col min-h-screen overflow-hidden">
      ...
      */}
      ...
      {/* 
        =======================================================================
        SECTION 2: DIRECTORY & COMMUNICATIONS GRID
        Deep analytical breakdown of the contact logistics.
        =======================================================================
      */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <div className="lg:col-span-4 relative">
              <div className="sticky top-40">
                <div className="font-playfair text-[#1B4F9B] text-[8rem] font-bold opacity-5 mb-8 leading-none tracking-tighter">
                  {dict.dir_hq}
                </div>
                <h3 className="font-jakarta text-[11px] uppercase tracking-[0.4em] font-extrabold text-[#0A192F] mb-6 border-l-2 border-[#1B4F9B] pl-4">
                  {dict.dir_label}
                </h3>
                ...
                <p className="font-jakarta text-sm text-[#475569] leading-[1.8] font-medium pr-8">
                  {dict.dir_desc}
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-slate-200 shadow-sm">
                ...
                <div className="p-10 md:p-14 border-b md:border-b-0 md:border-r border-slate-200 bg-white hover:bg-[#F8FAFC] transition-colors duration-500 relative overflow-hidden group">
                  ...
                  <h5 className="font-jakarta text-[10px] uppercase tracking-[0.3em] font-extrabold text-[#475569] mb-4">
                    {dict.wa_label}
                  </h5>
                  <h6 className="font-playfair text-3xl font-bold text-[#0A192F] mb-2 tracking-tight">
                    {dict.wa_title}
                  </h6>
                  <p className="font-jakarta text-xs text-[#1B4F9B] font-bold uppercase tracking-widest mb-6">
                    {dict.wa_admin}
                  </p>
                  <p className="font-jakarta text-sm text-[#475569] leading-[1.8] font-medium mb-10">
                    {dict.wa_desc}
                  </p>
                  ...
                  <a 
                    ...
                    className="group/btn inline-flex items-center gap-4 font-jakarta text-[10px] uppercase tracking-[0.2em] font-extrabold text-[#1B4F9B] hover:text-[#0A192F] transition-colors"
                  >
                    {dict.wa_btn}
                ...
                <div className="p-10 md:p-14 bg-white hover:bg-[#F8FAFC] transition-colors duration-500 relative overflow-hidden group">
                  ...
                  <p className="font-jakarta text-xs text-[#0A192F] font-bold uppercase tracking-widest mb-6">
                    {dict.hq_reg}
                  </p>
      ...
      {/* 
        =======================================================================
        SECTION 3: BRUTALIST DIGITAL INQUIRY FORM
        High-end editorial form UI. Functional with loading and success states.
        =======================================================================
      */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
            ...
            <div className="lg:col-span-5 relative z-10">
              <header className="mb-12">
                ...
                <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#0A192F] leading-[1.1] tracking-tight mb-8">
                  {dict.form_title}
                </h2>
                <p className="font-jakarta text-sm text-[#475569] leading-[1.8] font-medium">
                  {dict.form_desc}
              ...
              <div className="bg-[#F8FAFC] border border-slate-200 p-8 md:p-10">
                <h4 className="font-jakarta text-[10px] uppercase tracking-[0.3em] font-extrabold text-[#0A192F] mb-6 border-b border-slate-200 pb-4">
                  {dict.notice_title}
                </h4>
                <ul className="space-y-4 font-jakarta text-sm text-[#475569] font-medium">
            ...
            <div className="lg:col-span-7">
              {!isSubmitted ? (
                <form onSubmit={handleTransmit} className="space-y-12 transition-opacity duration-500">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="relative group">
                      <input 
                        ...
                        className="peer w-full bg-transparent border-0 border-b-2 border-slate-200 text-[#0A192F] font-jakarta text-lg py-3 focus:outline-none focus:ring-0 focus:border-[#1B4F9B] transition-colors placeholder-transparent disabled:opacity-50"
                        placeholder={dict.field_name}
                        required 
                      />
                      <label 
                        htmlFor="fullName" 
                        className="absolute left-0 -top-6 font-jakarta text-[10px] uppercase tracking-[0.2em] font-extrabold text-[#475569] transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-3 peer-focus:-top-6 peer-focus:text-[10px] peer-focus:text-[#1B4F9B]"
                      >
                        {dict.field_name}
                      </label>
                    </div>
                  ...
                  <div className="relative group">
                    <input 
                      ...
                      disabled={isSubmitting}
                      className="peer w-full bg-transparent border-0 border-b-2 border-slate-200 text-[#0A192F] font-jakarta text-lg py-3 focus:outline-none focus:ring-0 focus:border-[#1B4F9B] transition-colors placeholder-transparent disabled:opacity-50"
                      placeholder={dict.field_subject}
                      required 
                    />
                    <label 
                      htmlFor="subject" 
                  ...
                  <div className="relative group pt-4">
                    <textarea 
                      ...
                      rows={5}
                      disabled={isSubmitting}
                      className="peer w-full bg-transparent border-0 border-b-2 border-slate-200 text-[#0A192F] font-jakarta text-lg py-3 focus:outline-none focus:ring-0 focus:border-[#1B4F9B] transition-colors placeholder-transparent resize-none disabled:opacity-50"
                      placeholder={dict.field_message}
                      required 
                    ></textarea>
                    <label 
                      htmlFor="message" 
                      className="absolute left-0 -top-2 font-jakarta text-[10px] uppercase tracking-[0.2em] font-extrabold text-[#475569] transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-5 peer-focus:-top-2 peer-focus:text-[10px] peer-focus:text-[#1B4F9B]"
                    >
                      {dict.field_message}
                    </label>
                  </div>
                  ...
                  <div className="pt-8 relative">
                    <button 
                      type="submit" 
                      disabled={isSubmitting}
                      className="group inline-flex items-center justify-center gap-4 font-jakarta text-xs uppercase tracking-[0.3em] font-extrabold bg-[#0A192F] text-white px-16 py-6 hover:bg-[#1B4F9B] transition-colors duration-500 w-full md:w-auto shadow-xl disabled:bg-slate-400 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
                        ...
                        <>
                          {dict.btn_transmit}
                          <svg className="w-4 h-4 transition-transform duration-500 group-hover:translate-x-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                          </svg>
                        </>
                      )}
                ...
                <div className="bg-[#F8FAFC] border border-[#1B4F9B] p-12 md:p-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
                  ...
                  <h3 className="font-playfair text-3xl md:text-4xl font-bold text-[#0A192F] mb-6 tracking-tight">
                    {dict.success_title}
                  </h3>
                  <p className="font-jakarta text-base text-[#475569] leading-relaxed font-medium mb-10">
                    {dict.success_desc}
                  </p>
                  <button 
                    onClick={() => setIsSubmitted(false)}
                    className="font-jakarta text-[10px] uppercase tracking-[0.3em] font-extrabold text-[#1B4F9B] border-b-2 border-[#1B4F9B] pb-1 hover:text-[#0A192F] hover:border-[#0A192F] transition-colors"
                  >
                    {dict.success_btn}
                  </button>
                </div>
      ...
      {/* 
        =======================================================================
        SECTION 4: TERMINAL ACTION FOOTER
        Completely unified, high-end white-and-blue minimalist frame.
        =======================================================================
      */}
      <section className="py-32 md:py-48 bg-[#F8FAFC] relative border-t border-slate-200">
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24 relative z-10 text-center flex flex-col items-center">
          <div className="flex items-center gap-6 mb-8">
            ...
            <span className="font-jakarta text-[11px] uppercase tracking-[0.4em] font-extrabold text-[#1B4F9B]">
              {dict.footer_label}
            </span>
            <div className="h-px w-12 bg-[#1B4F9B]"></div>
          </div>
          ...
          <p className="font-jakarta text-[#475569] text-lg md:text-xl font-medium max-w-3xl mb-16 leading-relaxed">
            {dict.footer_desc}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
            <Link 
              href={`/${locale}/donate`}
              className="group inline-flex items-center justify-center gap-4 font-jakarta text-[11px] uppercase tracking-[0.3em] font-extrabold bg-[#0A192F] text-white px-14 py-6 hover:bg-[#1B4F9B] transition-colors duration-500 shadow-xl"
            >
              {dict.footer_btn1}
            ...
            <Link 
              ...
              className="font-jakarta text-[11px] uppercase tracking-[0.3em] font-extrabold bg-transparent text-[#0A192F] border-2 border-[#0A192F] px-14 py-6 hover:bg-white transition-colors duration-500 flex items-center justify-center"
            >
              {dict.footer_btn2}
            </Link>
          </div>
